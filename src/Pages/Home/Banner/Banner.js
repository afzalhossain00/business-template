            ...
            <div className="hero h-[500px] mb-5" style={{ backgroundImage: `url("https://images.pexels.com/photos/3184292/pexels-photo-3184292.jpeg?auto=compress&cs=tinysrgb&w=600")` }}>
                ...
                <div className="hero-content text-center text-neutral-content">
                    <div className="max-w-md text-accent">
                        ...
                        <button className="inline-block cursor-pointer rounded-md bg-base-100 px-10 py-3 text-center text-sm font-bold uppercase text-accent transition duration-200 ease-in-out  hover:bg-success">LEARN MORE</button>
                    </div>
                </div>
            </div>
        </div>
